...
public class EdScreenRecorderPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler,
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        ...
        if (call.method.equals("startRecordScreen")) {
            try {
                ...
                customSettings(videoFrame, videoBitrate, fileOutputFormat,videoEncoder);
    ...
    private void customSettings(int videoFrame, int videoBitrate, String fileOutputFormat, String videoEncoder) {
